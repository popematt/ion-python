...
from amazon.ionbenchmark.benchmark_runner import BenchmarkResult, SampleDist
...
def report_stats(benchmark_spec: BenchmarkSpec, benchmark_result: BenchmarkResult, report_fields: list):
     ...
     * `rate_<stat>` – throughput statistic for the benchmark
    ...
    for requested_field in report_fields:
        for field in REPORT_FIELDS:
            if requested_field == field.name:
